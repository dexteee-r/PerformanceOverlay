...
// Repli 2D du noyau « FLUX DE CHARGE » (quand l'effet 3D est désactivé) :
// arc de charge lissé + halo coloré + onde d'énergie + 2 anneaux en rotation.
// Léger, sans dépendance Quick3D. (La lecture centrale est posée par CenterVisual.)
Item {
    id: cv
